...
$anggota = "SELECT * FROM tbl_anggota WHERE id_anggota='$id'";
    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                ...
                <div class="body">
                    <form method="post" action="anggota/update.php">
                        <label for="id_anggota">ID</label>
                        <div class="form-group">
                            <div class="form-line">
                                <input type="text" id="id_anggota" name="id_anggota" class="form-control" value="<?php echo $data['id_anggota']; ?>" readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="form-line">
                                <input type="date" id="tgl_lahir" name="tgl_lahir" class="form-control" value="<?php echo $data['tgl_lahir']; ?>" required>
                            </div>
                        </div>
